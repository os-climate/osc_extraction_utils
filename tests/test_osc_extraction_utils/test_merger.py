...
from osc_extraction_utils.settings import MainSettings, S3Settings, MainBucketSettings, InterimBucketSettings
...
def test_return_s3_communication_main(merger: Merger,
    ...
    with (patch('osc_extraction_utils.merger.S3Communication') as mocked_s3_communication,

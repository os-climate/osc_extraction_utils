...
# class S3Controller:
#     def __init__(self, main_bucket: S3Communication, interim_bucket: S3Communication, settings: S3Settings):
...
#             s3_bucket.download_files_in_prefix_to_dir(path_with_prefix_in_s3, path_source_folder)
...
#         if S3Settings.s3_usage:
#             s3_bucket.upload_files_in_dir_to_prefix(path_destination_annotation_folder, path_with_prefix_in_s3)
